    ...
    const buttons = (
      <React.Fragment>
         <Link to="/book-apnt" onClick={() => this.onBookNowClick("false") } className="ui positive right labeled icon button"> <i className="right arrow icon"></i>
          ...
          <Link to="/pkgs/p4" onClick={() => this.onCancelClick("false") } className="ui black button">Cancel</Link>
     ...
     <div className="buttons" >
          <div className="containerr">
            ...
            {activeModalStatus === "true" ? (
              <Modal
                title="Right - Package4"
                content="Package4 - How's it going Buddy!"
                actions={buttons}
...
export default connect(mapStateToProps, {activeModal, activeMenu , leftButton})(Package4);
