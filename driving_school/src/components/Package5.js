...
class Package5 extends React.Component {
        ...
        >
          <div className="column">
            <div className="ui raised segment">
              ...
              <h3>
                Welcome to our package 5. Package 5 is for an ambulance license.
                With our Package 5 you will get the best training with our
                interactive lessons and amazing trainers. Package 5 at BDS
                offers lessons for the young and mature drivers of canada with a
                new approach to collision-free and fast driving.
              </h3>
              ...
              <h3>
                The binary driving school's package 5 offers flexible courses
                for new drivers for Class 4 license, which includes:
                <ul className="list-unstyled">
                  <li style={{ marginBottom: "5px" }}>
                    60 hrs theory done in a classroom setting - Applicant must
                    be at least 18 years of age
                  </li>
                  <li style={{ marginBottom: "5px" }}>
                    55 hours e-learning done online
                  </li>
                  <li style={{ marginBottom: "5px" }}>
                    The Binary Driving School ambulance vehicle student workbook
                  </li>
                  <li style={{ marginBottom: "5px" }}>
