    ...
    const buttons = (
      <React.Fragment>
         <Link to="/book-apnt" onClick={() => this.onBookNowClick("false") } className="ui positive right labeled icon button"> <i className="right arrow icon"></i>
          ...
          <Link to="/pkgs" onClick={() => this.onCancelClick("false") } className="ui black button">Cancel</Link>
      ...
      <div className="column" >
          <div className="ui raised segment">
                <p className="ui red ribbon label">Overview</p>
                    <h3>At Binary Driving School, we are committed to helping students become competent, 
                        responsible and defensive drivers. Binary driving school offers lessons for the young drivers of 
                        canada with a new approach to collision-free driving.
                    </h3>
     ...
     <div className="buttons" >
          <div className="containerr">
            ...
            {activeModalStatus === "true" ? (
              <Modal
                title="Hey Right Buddy"
                content="How's it going Buddy!"
                actions={buttons}
...
export default connect(mapStateToProps, {activeModal, activeMenu , leftButton})(Package1);
